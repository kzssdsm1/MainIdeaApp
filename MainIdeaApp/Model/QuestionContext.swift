...
struct QuestionContext {
    ...
    static let question_1 = Question(
        ...
        correctAnswerText: "コウモリが｜逆《さか》さまにぶら｜下《さ》がっている",
    ...
    static let question_2 = Question(
        ...
        correctAnswerText: "セミの｜幼虫《ようちゅう》は｜土《つち》の｜中《なか》",
    ...
    static let question_3 = Question(
        ...
        correctAnswerText: "おもちゃ｜箱《ばこ》からクマのぬいぐるみを｜取《と》り｜出《だ》した",
    ...
    static let question_4 = Question(
        correctAnswerIndex: 2,
        correctAnswerText: "おばあちゃんは｜白《しろ》いネコをひざに｜乗《の》せて｜微笑《ほほえ》んでいる",
    ...
    static let question_5 = Question(
        correctAnswerIndex: 0,
        correctAnswerText: "｜男《おとこ》の｜子《こ》がおいしそうにおにぎりを｜食《た》べている",
    ...
    static let question_6 = Question(
        correctAnswerIndex: 1,
        correctAnswerText: "｜馬《うま》に｜乗《の》った｜男《おとこ》の｜子《こ》",
    ...
    static let question_7 = Question(
        correctAnswerIndex: 0,
        correctAnswerText: "お｜医者《いしゃ》さんにのどを｜診《み》て｜貰《もら》っている｜男《おとこ》の｜子《こ》",
    ...
    static let question_8 = Question(
        correctAnswerIndex: 1,
        correctAnswerText: "粘土で｜楽《たの》しそうに恐竜を｜作《つく》る｜男《おとこ》の｜子《こ》",
    ...
    static let question_9 = Question(
        correctAnswerIndex: 2,
        correctAnswerText: "お｜友達《ともだち》と｜二人《ふたり》で｜恐竜《きょうりゅう》を｜見《み》つけた",
    ...
    static let question_10 = Question(
        correctAnswerIndex: 0,
        correctAnswerText: "やっと｜弟《おとうと》が｜寝《ね》たのに、お｜兄《にい》ちゃんが｜泣《な》き｜出《だ》して｜困《こま》っているママ",
    ...
    static let question_11 = Question(
        correctAnswerIndex: 2,
        correctAnswerText: "おばあちゃんは｜車《くるま》いすで｜施設《しせつ》の｜人《ひと》とお｜散歩《さんぽ》",
    ...
    static let question_12 = Question(
        correctAnswerIndex: 2,
        correctAnswerText: "｜坂道《さかみち》をお｜母《かあ》さんが｜子《こ》ども｜二人《ふたり》と｜楽《たの》しそうに｜登《のぼ》る",
    ...
    static let question_13 = Question(
        correctAnswerIndex: 2,
        correctAnswerText: "パパと｜虫《むし》とり｜楽《たの》しいな",
    ...
    static let question_14 = Question(
        correctAnswerIndex: 2,
        correctAnswerText: "プリンを｜見《み》て｜喜《よろこ》んでいる｜女《おんな》の｜子《こ》",
    ...
    static let question_15 = Question(
        correctAnswerIndex: 2,
        correctAnswerText: "｜虫《むし》を｜見《み》つけて｜怖《こわ》がる｜男《おとこ》の｜子《こ》",
    ...
    static let question_16 = Question(
        correctAnswerIndex: 2,
        correctAnswerText: "｜運動会《うんどうかい》で｜白組《しろぐみ》｜紅組《あかぐみ》に｜分《わ》かれて｜玉《たま》｜入《い》れ",
    ...
    static let question_17 = Question(
        correctAnswerIndex: 1,
        correctAnswerText: "｜家族《かぞく》でお｜出《で》かけ、お｜外《そと》でお｜弁当《べんとう》を｜食《た》べる",
    ...
    static let question_18 = Question(
        correctAnswerIndex: 2,
        correctAnswerText: "ママは｜窓《まど》を｜開《あ》けて｜部屋《へや》の｜換気《かんき》をしている",
    ...
    static let question_19 = Question(
        correctAnswerIndex: 1,
        correctAnswerText: "｜家族《かぞく》でワールドカップを｜観戦《かんせん》する",
    ...
    static let question_20 = Question(
        correctAnswerIndex: 0,
        correctAnswerText: "｜男《おとこ》の｜子《こ》と｜女《おんな》の子｜二人《ふたり》で｜楽《たの》しそうに｜踊《おど》ってる",
    ...
    static let question_21 = Question(
        correctAnswerIndex: 0,
        correctAnswerText: "こたつの｜上《うえ》にミカン、ネコが｜気持《きも》ちよく｜温《あたた》まっている",
    ...
    static let question_22 = Question(
        correctAnswerIndex: 2,
        correctAnswerText: "｜手《て》に｜乗《の》るインコを｜見《み》て｜微笑《ほほえ》む｜女性《じょせい》",
    ...
    static let question_23 = Question(
        correctAnswerIndex: 1,
        correctAnswerText: "｜男《おとこ》の｜人《ひと》が｜三匹《さんびき》の｜犬《いぬ》とお｜散歩《さんぽ》",
    ...
    static let question_24 = Question(
        correctAnswerIndex: 0,
        correctAnswerText: "｜二人《ふたり》でお｜掃除《そうじ》",
    ...
    static let question_25 = Question(
        correctAnswerIndex: 1,
        correctAnswerText: "｜石鹸《せっけん》で｜手《て》を｜洗《あら》う｜女《おんな》の｜人《ひと》",
    ...
    static let question_26 = Question(
        correctAnswerIndex: 1,
        correctAnswerText: "お｜父《とう》さんにベーゴマで｜勝《か》って｜嬉《うれ》しい",
    ...
    static let question_27 = Question(
        correctAnswerIndex: 0,
        correctAnswerText: "｜親子《おやこ》｜二人《ふたり》キャンプで｜楽《たの》しくバーベキュー",
    ...
    static let question_28 = Question(
        correctAnswerIndex: 2,
        correctAnswerText: "｜試験《しけん》｜前《まえ》にネコをひざの｜上《うえ》に｜乗《の》せて｜勉強《べんきょう》を｜頑張《がんば》っている",
    ...
    static let question_29 = Question(
        correctAnswerIndex: 2,
        correctAnswerText: "｜白《しろ》い｜犬《いぬ》と｜子供《こども》が｜一緒《いっしょ》に｜寝《ね》ている",
    ...
    static let question_30 = Question(
        correctAnswerIndex: 0,
        correctAnswerText: "｜両親《りょうしん》と｜一緒《いっしょ》に｜七五三《しちごさん》のお｜参《まい》り",
